...
//
#ifndef _NAVIGATION_FORM_H_
#define _NAVIGATION_FORM_H_
...
private:
	...
	static const int FOOTER_STYLE_3 = 3;
	...
	Tizen::Graphics::Bitmap* __pOptionTrayNormalBitmap;
	Tizen::Graphics::Bitmap* __pOptionTrayPressBitmap;
