...
PID: 3393
Date: 2013-03-04 11:24:30(GMT+0900)
Executable File Path: /opt/apps/i210nfM5xJ/bin/ProjectGiraffe
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3393, uid 5000)
      TIMER: -2
...
Callstack Information (PID:3393)
Call Stack Count: 29
 0: /usr/lib/osp/libosp-uifw.so.1(+0x54d737) [0xb376d737]
 1: /opt/apps/i210nfM5xJ/bin/ProjectGiraffe.exe(+0xb45e) [0xb3e7c45e]
 2: /opt/apps/i210nfM5xJ/bin/ProjectGiraffe.exe(+0xb6f1) [0xb3e7c6f1]
...
23: /opt/apps/i210nfM5xJ/bin/ProjectGiraffe.exe(OspMain+0x19f) [0xb3e77b1f]
